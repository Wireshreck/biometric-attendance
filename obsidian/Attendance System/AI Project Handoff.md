...
- CI: GitHub Actions run `36148997541` passed both ESP32 firmware compile and backend smoke/database/API test jobs on commit `06f7713`, using the workflow's Python 3.11 backend runner. Check the latest run because later commits can introduce new failures.
